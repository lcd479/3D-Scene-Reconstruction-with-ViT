...
from config import cfg, update_config, vit_config
...
tb_writer = SummaryWriter('./runs/01.18AM/')
# ---- Read cfg ----
...
VIT_CONFIGS = {
    ...
    'R50-ViT-B_16': vit_config.get_r50_b16_config(),
...
for epoch_idx in range(start_epoch ,cfg.TRAIN.EPOCHS):    
    ...
    #if (epoch_idx + 1) % cfg.SAVE_FREQ == 0:
    
    if (epoch_idx + 1) % 5 == 0 : #% cfg.SAVE_FREQ == 50 :
        torch.save({
            'epoch': epoch_idx,
